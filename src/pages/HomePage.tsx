    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Apple Gift Cards</h1>
      ...
      <section className="py-24 bg-[#F5F5F7]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-semibold text-center mb-16">Почему Apple Gift Cards?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Разблокируйте доступ к миллионам приложений, игр и многому другому</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Оплачивайте подписки на Apple Music, фильмы и сериалы</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">Дарите близким свободу выбора в экосистеме Apple</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-semibold mb-6">Готовы сделать выбор?</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Доступны карты номиналом 1000, 2500 и 5000 рублей для различных потребностей
          </p>
          <Button 
            asChild
